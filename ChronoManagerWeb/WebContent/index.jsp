...
<title>ChronoManager -  Inicio</title>
...
<!-- fwtable fwsrc="banner_ctp_rh.png" fwpage="Page 1" fwbase="plantilla.png" fwstyle="Dreamweaver" fwdocid = "1063142010" fwnested="0" -->
  ...
  <tr>
   ...
   <!-- InstanceBeginEditable name="titulo" -->Colocar el titulo<!-- InstanceEndEditable --></h2>
  ...
  <tr height="100%">
   ...
   <td colspan="7" valign="top" height="100%"><!-- InstanceBeginEditable name="contenido" -->Colocar el contenido<!-- InstanceEndEditable -->   </td>
